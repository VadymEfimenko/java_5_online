...
export class AuthService {
  ...
  login(username: string, password: string): Observable<any> {
    return this.process(username, password, appSettings.apiOpen + '/auth/authenticate');//todo ???
  }

  register(username: string, password: string): Observable<any> {
    return this.process(username, password, appSettings.apiOpen + '/auth/register');//todo return this.process(username, password, appSettings.apiOpen + '/auth/authenticate');
  }
